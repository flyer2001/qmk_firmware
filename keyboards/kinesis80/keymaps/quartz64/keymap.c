...
* |--------+------+------+------+------+------|                           |------+------+------+------+------+--------|
* |CAPS/shift| A⌃ |  S ⌥ |  D ⌘ |  F ⇧ |  G   |                           |   H  |  J ⇧ |  K ⌘ |  L ⌥ | ;: ⌃ | '"/NM  |
* |--------+------+------+------+------+------|                           |------+------+------+------+------+--------|
* |  Arrow |  Z   |   X  |   C  |   V  |   B  |                           |   N  |   M  |  ,.  |  .>  |  /?  | Arrow  |
* `--------+------+------+------+------+-------                           `------+------+------+------+------+--------'
...
[_BASE] = LAYOUT(
    ...
    LT(_ARROW, KC_LBRC),KC_Z,   KC_X,   KC_C,   KC_V,      KC_B,      KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH,   LT(_ARROW, KC_RBRC),
...
[_ARROW] = LAYOUT(
    ...
    _______,KC_LCTL, KC_LEFT, LGUI_T(KC_DOWN), LSFT_T(KC_RGHT),_______,_______, RSFT_T(KC_LEFT),RGUI_T(KC_DOWN), KC_RGHT, KC_RCTL,  _______,
    _______, _______, _______, _______, _______, _______,      _______, _______,   _______, _______,  _______,  _______,
