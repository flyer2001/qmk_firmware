...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
   * | Ctrl |Ins/L2| Alt  |  [   |  ]   |Space |`------'`------'|Enter | left | down |  up  |right |AltGr |
   * `-----------------------------------------'                `-----------------------------------------'
   */
  [BASE] = LAYOUT(
    ...
    KC_LCTL,        LT(FN2,KC_INS), KC_LALT, KC_LBRC, KC_RBRC, KC_SPC, KC_BSPC,  KC_DEL,    KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_RALT
  ),
   ...
   * |------+------+------+------+------+------|                |------+------+------+------+------+------|
   * | trns |PrScr |  ML  |  MDn |  MR  | F12  |,------.,------.| pgup |  1   |  2   |  3   |   =  | trns |
   * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
   * |MWhUp |  F6  |  F7  |  F8  |  F9  | F10  || trns || trns || pgdn |  0   |  .   |Enter |  [   |   ]  |
   * |------+------+------+------+------+------||      ||      ||------+------+------+------+------+------|
   * |MWhDn | trns |      |      |      | trns |`------'`------'| trns | left | down |  up  |right | Ctrl |
   * `-----------------------------------------'                `-----------------------------------------'
   */
  [FN1] = LAYOUT(
    ...
    KC_WH_R, _______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_RCTL
  ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
      ...
      if (record->event.pressed) {
		...
		SEND_STRING(SS_TAP(X_RCTRL));
		_delay_ms(500);
        SEND_STRING(SS_LCTRL("0")"NakedLunch1991"SS_TAP(X_ENTER));
      }
      return false;
      break;
	  ...
	  case PWD3:
      if (record->event.pressed) {
        SEND_STRING(SS_LCTRL("0")"EraserHead1976"SS_TAP(X_ENTER));
      }
      return false;
      break;
	  ...
	  case EMAIL1:
      if (record->event.pressed) {
        SEND_STRING(SS_LCTRL("0")"quartz64@gmail.com");
      }
      return false;
      break;
  }
