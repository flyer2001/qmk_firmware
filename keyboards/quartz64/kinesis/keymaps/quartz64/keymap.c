...
*
* ,--------------------------------------------                           --------------------------------------------.
* |   F1   |au on |au off|      |sol - | sol +|                           |ck tg |ck up |ck dn |ck rst| F11  |  F12   |
* |--------+------+------+------+------+------+                           +------+------+------+------+------+--------|
* |        |      |      |      |sol-bz|sol-tg|                           |ScrLk |Numlck|  =   |  /   |  *   |        |
* |--------+------+------+------+------+------|                           +------+------+------+------+------+--------|
...
*/
[_NM] = LAYOUT(
    KC_F1,   AU_ON,   AU_OFF,  _______, HPT_DWLD, HPT_DWLI,    CK_TOGG, CK_UP,   CK_DOWN, CK_RST,  KC_F11,  KC_F12,
    _______, _______, _______, _______, HPT_BUZ, HPT_TOG,   KC_SLCK, KC_NLCK, KC_PEQL, KC_PSLS, KC_PAST, _______,
